...
_parser_train.add_argument('--sw', type=float,  nargs='+', default = [1000,1000,1000,1000], help='style weight in each layer')
...
_parser_train.add_argument('--backbone', type=str, default='vgg16', help='backbone choice: vgg16, efficientnet_b3')
